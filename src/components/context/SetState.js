...
const SetState=(props)=>{
     ...
     const fetchingdata=async(setdata)=>{
        ...
        // https://api.airtable.com/v0/appI2TY2F0bnyL4rm/Comparision%20Table/recsUvOBrpMGxDQnC?fields%5B%5D=-fldlRyR54qzwHyEIs,-fld6nUtXYrisQRn7o&filterByFormula={FIELD_NAME}='{FIELD_VALUE}'
    ...
    const fetchingdata1=async()=>{
      ...
      var get =  await JSON.parse(localStorage.getItem('project'));
       ...
       // setprojectdata(projectdata => {
         ...
         //   return [...projectdata, parsedData.records]; // use the push() function to add newItem to the prevItems array
          //});
        //const l= getKey(parsedData.records.fields)
  ...
  //  setprojectdata(projectdata => {
    ...
    return(<MyContext.Provider value={{comparedata,setcomparedata,columnNames,setColumnNames,fetchingdata,fetchingdata1,handlecompare,projectdata,getKey,fetchfunction,item1,setitem1,item2,setitem2,item3,setitem3,able,setable,setprojectdata,fetchingprojectdata}}>
        {props.children}
 </MyContext.Provider>);
}
